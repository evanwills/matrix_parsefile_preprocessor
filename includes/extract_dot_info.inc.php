...
if( !defined('MATRIX_PARSEFILE_PREPROCESSOR__EXTRACT_DOT_INFO') )
{

define('MATRIX_PARSEFILE_PREPROCESSOR__EXTRACT_DOT_INFO',true);
...
{
	$info_array = array();
	if(is_file($info_content) && strtolower($info_content) != 'debug.info' )
	{
